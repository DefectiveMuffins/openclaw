...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  {
    ...
    sectionId: "fs",
    profiles: ["coding", "orchestrator", "manager"],
  },
  {
    id: "write",
    label: "write",
  ...
  },
  {
    ...
    sectionId: "sessions",
    profiles: ["coding", "messaging", "orchestrator", "manager"],
    includeInOpenClawGroup: true,
  },
  {
    id: "sessions_history",
  ...
  {
    id: "subagent_review",
    label: "subagent_review",
    description: "Review completed sub-agent results",
    sectionId: "sessions",
    profiles: ["manager"],
    includeInOpenClawGroup: true,
  },
  {
    ...
    sectionId: "sessions",
    profiles: ["minimal", "coding", "messaging", "orchestrator", "manager"],
    includeInOpenClawGroup: true,
  },
  {
    id: "browser",
...
const CORE_TOOL_PROFILES: Record<ToolProfileId, ToolProfilePolicy> = {
  ...
  manager: {
    allow: listCoreToolIdsForProfile("manager"),
  },
  full: {},
};
